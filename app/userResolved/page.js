                            ...
                            <div className="flex justify-between h-16 items-center">
                                ...
                                {expand && (
                                    <div className="md:hidden mt-30 ml-7 space-y-2 bg-white px-4 py-2 shadow rounded-lg absolute z-10">
                                        ...
                                        <Link href="/my-complaints" className="block text-gray-700 hover:text-indigo-600">File Complaints</Link>
                                ...
                                <div className="hidden md:flex space-x-8">
                                    ...
                                    <Link href="/my-complaints" className="text-gray-700 hover:text-indigo-600">
                                        File Complaints
                                    </Link>
                                    <Link href="/userResolved" className="text-gray-700 hover:text-indigo-600">
                                        Resolved Complaint
                                    </Link>
                                    <Link href="/community-updates" className="text-gray-700 hover:text-indigo-600">
                                        Community Updates
                                    </Link>
                                </div>
